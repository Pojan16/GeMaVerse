...
/** @param {import('./connection').et} conn */
export function HelperConnection(conn, options = {}) {
    let botUser = conn.user
    /** @type {import('@adiwajshing/baileys').WAet | import('@adiwajshing/baileys').WALegacyet} */
    let  = Object.defineProperties(conn, {
        decodeJid: {
            value(jid) {
    ...
    */
    ...
    conn.resize = async (buffer, uk1, uk2) => {
    	return new Promise(async(resolve, reject) => {
    		...
    		var ab = await baper.resize(high, width).getBufferAsync(jimp.MIME_JPEG)
    		resolve(ab)
    	})
    }
...
/**
 * Serialize Message
 * @param {ReturnType<typeof makeWAet>} conn 
 * @param {import('@adiwajshing/baileys').proto.WebMessageInfo} m 
...
export function serialize() {
    ...
    return Object.defineProperties(proto.WebMessageInfo.prototype, {
        ...
        quoted: {
            get() {
                /** @type {ReturnType<typeof makeWAet>} */
                const self = this
                const msg = self.msg
